...
func (cs *cosignService) getTxCode() string {
	...
	addressTemplates := map[string]string{
		"0xBATTLE_BLOCKS_ACCOUNTS_ADDRESS": viper.Get("BATTLE_BLOCKS_ACCOUNTS_ADDRESS").(string),
		"0xBATTLE_BLOCKS_NFT_ADDRESS":      viper.Get("BATTLE_BLOCKS_NFT_ADDRESS").(string),
		"0xFUNGIBLE_TOKEN_ADDRESS":         viper.Get("FUNGIBLE_TOKEN_ADDRESS").(string),
		"0xNON_FUNGIBLE_TOKEN_ADDRESS":     viper.Get("NON_FUNGIBLE_TOKEN_ADDRESS").(string),
	}
